<!DOCTYPE html>FIKDigital
<html lang="en">

<head>
    <meta charset="utf-8">
    <title>FIKDigital</title>
...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="51">
    <div class="container-xxl bg-white p-0">
            ...
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav mx-auto py-0">
                        ...
                        <a href="#pricing" class="nav-item nav-link">Preços</a>
                        <a href="#review" class="nav-item nav-link">Equipe</a>
                        <a href="#contact" class="nav-item nav-link">Contato</a>
                    </div>
                    <a href="" class="btn btn-primary-gradient rounded-pill py-2 px-4 ms-3 d-none d-lg-block">Cadastre-se</a>
                </div>
            </nav>
                ...
                <div class="container px-lg-5">
                    <div class="row g-5">
                        <div class="col-lg-8 text-center text-lg-start">
                            <h1 class="text-white mb-4 animated slideInDown">A REVOLUCAO DA SUA MARCA</h1>
                            <p class="text-white pb-3 animated slideInDown">Seja visto nas primeiras páginas, tenha sua Identidade Digital. Faça sua empresa FIKDigital</p>
                            <a href="" class="btn btn-primary-gradient py-sm-3 px-4 px-sm-5 rounded-pill me-3 animated slideInLeft">Saiba Mais</a>
                            <a href="" class="btn btn-secondary-gradient py-sm-3 px-4 px-sm-5 rounded-pill animated slideInRight">Contato</a>
                        </div>
            ...
            <div class="container py-5 px-lg-5">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                        <h5 class="text-primary-gradient fw-medium">Quem Somos</h5>
                        <h1 class="mb-4">#1 Para sua Marca FIKDigital</h1>
                        <p class="mb-4">De uma amizade iniciada a muitos anos, fundada na confiança e dedicação entre os mesmo, visando descentralizar os serviços de tecnologia fomentando o crescimento emrpesarial. Com embasamento nas melhores práticas do mercado, boas praticas ae metodologias desenvolvidas e homologadas, experiência adquirida no decorrer do percurso de amadurecimento da ideia e da especialização dos integrantes da sociedade , resultando nos bons frutos hoje colhidos e semeados para que, com um serviço personalizado e dedicado para cada cliente participante da nossa rede.</p>
        ...
        <div class="container-xxl py-5" id="feature">
            <div class="container py-5 px-lg-5">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h5 class="text-primary-gradient fw-medium">Serviços</h5>
                    <h1 class="mb-5">FIKDigital Serviços</h1>
                </div>
                <div class="row g-4">
        ...
        <div class="container-xxl py-5" id="pricing">
            <div class="container py-5 px-lg-5">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h5 class="text-primary-gradient fw-medium">Preços e Planos</h5>
                    <h1 class="mb-5">Escolha Seu Plano</h1>
                </div>
                <div class="tab-class text-center pricing wow fadeInUp" data-wow-delay="0.1s">
                    <ul class="nav nav-pills d-inline-flex justify-content-center bg-primary-gradient rounded-pill mb-5">
                        <li class="nav-item">
                            <button class="nav-link active" data-bs-toggle="pill" href="#tab-1">Mensal</button>
                        </li>
                        <li class="nav-item">
                            ...
                            <div class="row g-4">
                                <div class="col-lg-4">
                                    <div class="bg-light rounded">
                                        ...
                                        <div class="p-4 pt-0">
                                            <h1 class="mb-3">
                                                <small class="align-top" style="font-size: 22px; line-height: 45px;">R$</small>1.500<small
                                                    class="align-bottom" style="font-size: 16px; line-height: 40px;">/ Mês</small>
                                            </h1>
                                            <div class="d-flex justify-content-between mb-3"><span>LogoMarca</span><i class="fa fa-check text-primary-gradient pt-1"></i></div>
                                            <div class="d-flex justify-content-between mb-3"><span>Carlão de Visita</span><i class="fa fa-check text-primary-gradient pt-1"></i></div>
                                            <div class="d-flex justify-content-between mb-3"><span>Web Site</span><i class="fa fa-check text-primary-gradient pt-1"></i></div>
                                            <div class="d-flex justify-content-between mb-2"><span>Marketing de Redes Sociais</span><i class="fa fa-check text-primary-gradient pt-1"></i></div>
                                            <a href="" class="btn btn-primary-gradient rounded-pill py-2 px-4 mt-4">Aceitar</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="bg-light rounded border">
                                        ...
                                        <div class="p-4 pt-0">
                                            <h1 class="mb-3">
                                                <small class="align-top" style="font-size: 22px; line-height: 45px;">R$</small>2.499<small
                                                    class="align-bottom" style="font-size: 16px; line-height: 40px;">/ Mês</small>
                                            </h1>
                                            <div class="d-flex justify-content-between mb-3"><span>Plano Básico</span><i class="fa fa-check text-primary-gradient pt-1"></i></div>
                                            <div class="d-flex justify-content-between mb-3"><span>Identidade Digital & Visual</span><i class="fa fa-check text-primary-gradient pt-1"></i></div>
                                            <div class="d-flex justify-content-between mb-3"><span>Métricas e Relatórios</span><i class="fa fa-check text-primary-gradient pt-1"></i></div>
                                            <div class="d-flex justify-content-between mb-2"><span>Edição de Imagens</span><i class="fa fa-check text-primary-gradient pt-1"></i></div>
                                            <a href="" class="btn btn-secondary-gradient rounded-pill py-2 px-4 mt-4">Aceitar</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="bg-light rounded">
                                        <div class="border-bottom p-4 mb-4">
                                            <h4 class="text-primary-gradient mb-1">Plano FIKDigital</h4>
                                            <span>Powerful & Awesome Features</span>
                                        </div>
                                        <div class="p-4 pt-0">
                                            <h1 class="mb-3">
                                                <small class="align-top" style="font-size: 22px; line-height: 45px;">R$</small>3.499<small
                                                    class="align-bottom" style="font-size: 16px; line-height: 40px;">/ Mês</small>
                                            </h1>
                                            <div class="d-flex justify-content-between mb-3"><span>Plano Avançado</span><i class="fa fa-check text-primary-gradient pt-1"></i></div>
                                            <div class="d-flex justify-content-between mb-3"><span>Edição de Videos</span><i class="fa fa-check text-primary-gradient pt-1"></i></div>
                                            <div class="d-flex justify-content-between mb-3"><span>Mascote Personalizado</span><i class="fa fa-check text-primary-gradient pt-1"></i></div>
                                            <div class="d-flex justify-content-between mb-2"><span>Suporte Ilimitado</span><i class="fa fa-check text-primary-gradient pt-1"></i></div>
                                            <a href="" class="btn btn-primary-gradient rounded-pill py-2 px-4 mt-4">Aceitar</a>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="container-xxl py-5" id="review">
            <div class="container py-5 px-lg-5">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h5 class="text-primary-gradient fw-medium">EQUIPE FIKDigital</h5>
                    <h1 class="mb-5">O QUE TEMOS PARA FALAR DELES!</h1>
                </div>
        ...
        <div class="container-xxl py-5" id="contact">
            <div class="container py-5 px-lg-5">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h5 class="text-primary-gradient fw-medium">Fale com a FIKDigital</h5>
                    <h1 class="mb-5">Mande uma Mensagem!</h1>
                </div>
                <div class="row justify-content-center">
                    <div class="col-lg-9">
                        <div class="wow fadeInUp" data-wow-delay="0.3s">
                            <p class="text-center mb-4">Esperamos seu contato, venha evoluir seus conseitos FIKDigital, sua empresa vai ser vista na nova era FIKDIGITAL!</a>.</p>
                            <form>
                                <div class="row g-3">
                                    <div class="col-md-6">
